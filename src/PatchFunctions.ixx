...
export void DisableHeightRestriction() {
...
export void IncreasedJCSpheres() {
...
export void ImprovedBufferedReversals() {
...
export void DisableJCRestriction() {
...
export void CameraSensController() {
...
export void CameraFollowUpSpeedController() {
...
export void CameraDistanceController() {
...
export void CameraLockOnDistanceController() {
	auto pool_4449 = *reinterpret_cast<byte8***>(appBaseAddr + 0xC8FBD0);
	if
		(
			!pool_4449 ||
...
export void CameraTiltController() {
	auto pool_4449 = *reinterpret_cast<byte8***>(appBaseAddr + 0xC8FBD0);
	if
		(
			!pool_4449 ||
...
export void LockedOffCameraToggle(bool enable) {
...
export void DisableAirSlashKnockback() {
...
export void OverrideTauntInAir(bool enable) {
...
export void AirTauntToggleController(byte8* actorBaseAddr) {
	if (!actorBaseAddr) {
		return;
	}
