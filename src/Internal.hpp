...
typedef void(__fastcall* func_594B0_t)(BodyPartData& bodyPartData, byte8* file, uint32 bodyPart, uint32, byte8** motionArchives, byte8*** modelDataFunctions, PhysicsMetadata** modelPhysicsMetadataPool, float32* motionSpeed, void*);
...
extern func_1DE820_t func_1DE820; // (uint32 character, uint32 id, bool isClone)
...
extern func_280120_t func_280120; // (byte8 * dest, uint32 side, uint32 index)
...
extern func_1F97F0_t func_1F97F0; // (byte8 * actorData, bool noMotion)
extern func_1F94D0_t func_1F94D0; // (byte8 * actorData, uint8 index)
extern func_1EAE60_t func_1EAE60; // (byte8 * actorData, uint8 index)
...
extern func_594B0_t func_594B0; // (BodyPartData & bodyPartData, byte8 * file, uint32 bodyPart, uint32, byte8 ** motionArchives, byte8 *** modelDataFunctions, PhysicsMetadata ** modelPhysicsMetadataPool, float32 * motionSpeed, void *)
