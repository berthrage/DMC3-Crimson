...
void ToggleInfiniteHitPoints(bool enable) {
    LogFunction(enable);
...
void ToggleInfiniteMagicPoints(bool enable) {
    LogFunction(enable);
...
void ToggleDisableTimer(bool enable) {
    LogFunction(enable);
...
void ToggleInfiniteBullets(bool enable) {
    LogFunction(enable);
