...
struct CrimsonInput {
	...
	struct ButtonConfig {
		...
		// Taunt (index 14) defaults to slot B = TOUCHPAD_RIGHT on all characters.
		BindPair dante1P[NUM_GAMEPADBINDS] = {
			...
			{GAMEPAD::RIGHT_TRIGGER, 0},    {GAMEPAD::RIGHT_STICK_CLICK, 0}, {GAMEPAD::BACK, GAMEPAD::TOUCHPAD_RIGHT}, {GAMEPAD::START, 0},
