...
struct CrimsonInput {
	...
	struct ButtonConfig {
		uint16_t dante1P[NUM_GAMEPADBINDS] = {
			GAMEPAD::UP,    GAMEPAD::DOWN,  GAMEPAD::RIGHT, GAMEPAD::LEFT,
			GAMEPAD::Y,     GAMEPAD::A,     GAMEPAD::B,     GAMEPAD::X,
			GAMEPAD::LEFT_SHOULDER,   GAMEPAD::LEFT_TRIGGER,     GAMEPAD::LEFT_STICK_CLICK,  GAMEPAD::RIGHT_SHOULDER,
			GAMEPAD::RIGHT_TRIGGER,    GAMEPAD::RIGHT_STICK_CLICK, GAMEPAD::BACK,              GAMEPAD::START,
			GAMEPAD::RIGHT_STICK_CLICK  // SWITCH_BUTTON
		};
